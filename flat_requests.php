...
$id = $_SESSION['id'];
$fifa = $user->getFlatHouseOwner($id);
//var_dump($fifa);
...
?>
	...
	<div class="col-md-offset-1 col-md-10">
			...
			<?php foreach ($fifa as $result) {
				$name=$result['flat_id'];
				$pirlo=$result['customer_id'];
				$buffon=$user->getCustomerId($pirlo);
				...
				<div class="final">
					<div class="row">
						...
						<div class="col-md-4">
							...
							<p> Name: <?php echo $buffon['customer_name'];?> </p>
								<p> Email: <?php echo $buffon['customer_email'];?> </p>
								<p> Phone: <?php echo $buffon['customer_phone_number'];?></p>
								<p> Occupation: <?php echo $buffon['customer_occupation']; ?> </p>
