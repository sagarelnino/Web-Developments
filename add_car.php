...
if(isset($_POST['submit']))
{
	...
	$user->AddCar($car_type,$car_phone_number,$car_rate);
	header("location:car_admin.php");
}
...
?>
	...
	<div class="container">
		...
		<div class="profile">
			<div class="col-md-4">
				<img class="img-circle" alt="Cinque Terre" width="404" height="436" src="pic/1024px-Insert_image_here.svg.png">


					<h3> Insert The pic Afterwards</h3>
			</div>
				...
				<div class="details">
					<form method="POST">
					  <div class="form-group">
					    ...
					    <input type="text" class="form-control" id="formGroupExampleInput" name="car_type" >
					  </div>
					  <div class="form-group">
					    <label for="formGroupExampleInput2">Phone Number</label>
					    <input type="text" class="form-control" id="formGroupExampleInput2" name="car_phone_number">
					  </div>
					  
					  <div class="form-group">
					    <label for="formGroupExampleInput2">Rate</label>
					    <input type="text" class="form-control" id="formGroupExampleInput2" name="car_rate">
					  </div>
