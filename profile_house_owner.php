		...
		<div class="profile">
			...
			<div class="col-md-offset-2 col-md-4">
				<div class="details">
					...
					<p><i class="fa fa-money" aria-hidden="true"></i> Payment Method: <?php echo $doc['house_owner_payment_method'];?> </p>
					<p><i class="fa fa-money" aria-hidden="true"></i> Payment Id: <?php echo $doc['house_owner_payment_id'];?> </p>
