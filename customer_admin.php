	...
	<div class="container">
		...
		<div class="profile">
			...
			<div class="col-md-offset-2 col-md-4">
				...
				<div class="list">
				<button type="button" onclick="window.location.href='view_customers.php'" class="btn btn-success new">Back</button>
				<br>
				<button type="button" onclick="window.location.href='delete_customer.php?id=<?php echo $id; ?>'" class="btn btn-danger new"> Delete</button>
